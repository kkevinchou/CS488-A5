...
bench = gr.node('bench')
bench:translate(1, -0.4, 0.4)
plane:add_child(bench)

bench_body = gr.cube('bench_body')
bench_body:scale(bench_length, 0.1, bench_dim)
...
leg_back_right:translate(0, -1 * leg_length, bench_dim - leg_dim)
...
window_light = gr.light({1, 0.333, 0.5}, {1, 1, 1}, {1, 0, 0}, {1, 0, 0}, {0, -0.333, 0})
...
gr.render(scene_root, 'scene.png', 500, 500,
      {0, 0, 2.5}, {0, 0, -1}, {0, 1, 0}, 50,
      {0.25, 0.25, 0.25}, {window_light})